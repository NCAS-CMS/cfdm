...
from .subarray import SubsampledQuadraticLatitudeLongitudeSubarray


class SubsampledQuadraticLatitudeLongitudeArray(Subsampled, CompressedArray):
    ...
    *shape*, *ndim* and *size* parameters that describe the
    ...
    def __new__(cls, *args, **kwargs):
        ...
        instance._Subarray = SubsampledQuadraticLatitudeLongitudeSubarray
        return instance
