...
def LOG_SEVERITY_LEVEL(*log_level):
    ...
    to 'DEBUG' (or 5), all log messages are displayed. Note that it is
    also possible to disable all log messages, even those marked as
    'CRITICAL', via specifying 'DISABLE' (or 0), an effective lowest level.
    ...
    :Parameters:
        ...
        log_level: `str` ot `int`, optional
            ...
            the named set of levels, namely 'CRITICAL', 'ERROR', 'WARNING',
            'DEBUG', 'INFO', or an integer from 1 to 5 corresponding
            to each of these, where 1 is the highest severity ('CRITICAL')
            and 5 the lowest ('DEBUG'). You may also specify 'DISABLE' (0) to
    ...
    if log_level:
        ...
        if level in valid_log_levels:
            ...
            print(
                ...
                "corresponding integer of 0 to {} respectively (decreasing "
