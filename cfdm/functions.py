...
def LOG_SEVERITY_LEVEL(*log_level):
    ...
    The default level set by cf-python is 'WARNING' (1).
    ...
    **Examples:**
    ...
    'WARNING'
    >>> LOG_SEVERITY_LEVEL('INFO')  # change the value to 'INFO'
    'WARNING'
    >>> LOG_SEVERITY_LEVEL()
    'INFO'
    >>> LOG_SEVERITY_LEVEL(0)  # set to 'DISABLE' via corresponding integer
    'INFO'
    >>> LOG_SEVERITY_LEVEL()
    'DISABLE'
    '''
