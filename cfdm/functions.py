...
def _reset_log_severity_level(new_level):
    '''
    Re-set the minimum severity level for displayed log messages.

    This may correspond to a change, otherwise will re-set to the same value.
    '''
    logging.getLogger().setLevel(getattr(logging, new_level))  # root logger
