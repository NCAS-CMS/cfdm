...
#            64-bit integers as 32-bit integers. If False (the default)
#            then input data types are preserved.
#
#            .. versionadded:: (cfdm) NEXTVERSION
#
#        double: `bool`, optional
#            If True then write 32-bit floats as 64-bit floats and
#            32-bit integers as 64-bit integers. If False (the default)
#            then input data types are preserved.
#
#            .. versionadded:: (cfdm) NEXTVERSION
#
