...
#              storage chunk lies within exactly one Dask chunk. This
#              strategy is general the most performant, as it ensures
#              that when accessing the data, each storage chunk is read
#              from disk at most once (as opposed to once per Dask
#              chunk in which it lies).
#
...
#                and size 54.93 MiB when *dask_chunks* is ``'auto'``.)
#
...
#                (264, 264, 60) and maximum size 31.90 MiB when
#                *dask_chunks* is ``'auto'``.)
#
...
#                60) and maximum size 3.96 MiB when *dask_chunks* is
#                ``'auto'``.)
#
