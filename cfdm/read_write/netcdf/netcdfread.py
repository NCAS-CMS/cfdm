...
class NetCDFRead(IORead, Checker):
    ...
    #     document.
    # ================================================================
    # TODO move all _check methods below to conformance module, in
    # dedicated 'checker' module (Checker class inherited)! For now, only
    # include there the new classes for PR #373 to make reviewing simpler.
